...
public class MPU9150 implements PinOpenable {
	...
	private static final short SAMPRING_RATE = 100;
    ...
    // 地磁気センサのレジスタマップ
    private static final byte CTRL = 2;
	...
	public void getGeomagneticFromSensor(short[] geomagnetic) throws ConnectionLostException, InterruptedException{
		...
		readBytes(AK8975Address, CTRL, data);
